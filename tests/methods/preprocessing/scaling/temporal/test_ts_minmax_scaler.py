...
from tempor.methods.preprocessing.scaling.temporal.plugin_ts_minmax_scaler import TimeSeriesMinMaxScaler
...
def get_test_plugin(get_plugin: Callable):
    def func(plugin_from: str, base_kwargs: Dict):
        return get_plugin(
            plugin_from,
            fqn="preprocessing.scaling.temporal.ts_minmax_scaler",
            cls=TimeSeriesMinMaxScaler,
            kwargs=base_kwargs,
        )

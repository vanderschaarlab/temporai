...
from tempor.methods.preprocessing.imputation.static.plugin_static_tabular_imputer import StaticTabularImputer
...
def get_test_plugin(get_plugin: Callable):
    def func(plugin_from: str, base_kwargs: Dict):
        return get_plugin(
            plugin_from,
            fqn="preprocessing.imputation.static.static_tabular_imputer",
            cls=StaticTabularImputer,
            kwargs=base_kwargs,
        )

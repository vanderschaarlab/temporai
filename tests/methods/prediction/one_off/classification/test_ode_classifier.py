...
from tempor.methods.prediction.one_off.classification.plugin_ode_classifier import ODEClassifier
...
def test_sanity(get_test_plugin: Callable, plugin_from: str) -> None:
    ...
    assert test_plugin.full_name() == "prediction.one_off.classification.ode_classifier"

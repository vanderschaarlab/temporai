...
from tempor.methods.prediction.one_off.classification.plugin_laplace_classifier import LaplaceODEClassifier
...
def test_sanity(get_test_plugin: Callable, plugin_from: str) -> None:
    ...
    assert test_plugin.full_name() == "prediction.one_off.classification.laplace_ode_classifier"

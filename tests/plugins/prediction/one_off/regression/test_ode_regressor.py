...
from tempor.plugins.prediction.one_off.regression.plugin_ode_regressor import ODERegressor as plugin
...
def from_api() -> BaseOneOffRegressor:
    return plugin_loader.get("prediction.one_off.regression.ode_regressor", **train_kwargs)

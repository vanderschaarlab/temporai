...
class TestRegistration:
    ...
    def test_register_plugin_and_category_success(self):
        ...
        assert plugin_core.PLUGIN_REGISTRY[fqn] == DummyPlugin.cls  # type: ignore  # pylint: disable=no-member
    ...
    def test_register_multiple_plugins_and_categories_success(self):
        ...
        assert plugin_core.PLUGIN_REGISTRY[p_a1.fqn()] == DummyPluginA1.cls  # type: ignore  # pylint: disable=no-member
        assert plugin_core.PLUGIN_REGISTRY[p_a2.fqn()] == DummyPluginA2.cls  # type: ignore  # pylint: disable=no-member
        assert plugin_core.PLUGIN_REGISTRY[p_b1.fqn()] == DummyPluginB1.cls  # type: ignore  # pylint: disable=no-member

...
from tempor.plugins.preprocessing.scaling.static.plugin_static_standard_scaler import StaticStandardScaler as plugin
...
def from_api() -> BaseScaler:
    return plugin_loader.get("preprocessing.scaling.static.static_standard_scaler", **train_kwargs)

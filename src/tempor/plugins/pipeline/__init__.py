...
class PipelineMeta(type):
    ...
    def fit(self: Any, X: dataset.BaseDataset, *args: Any, **kwargs: Any) -> Any:
        raise NotImplementedError("Not implemented")

    def predict(*args: Any, **kwargs: Any) -> dataset.BaseDataset:  # pylint: disable=no-method-argument
        raise NotImplementedError("Not implemented")

    def predict_proba(*args: Any, **kwargs: Any) -> dataset.BaseDataset:  # pylint: disable=no-method-argument
        raise NotImplementedError("Not implemented")
